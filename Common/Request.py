...
class Request:
    ...
    def get_request(self, url, params=None, headers=None, cookies=None):
        ...
        self.log.info('----请求用时: %s 秒' % time_consuming)
    ...
    @logs
    def put_request(self, url, data=None, headers=None, json=None, cookies=None):
        """
        Put请求
        :param url:
        :param data:
        ...
        try:
            if data is None:
                response = requests.put(url, headers=headers, json=json, cookies=cookies)
            else:
                response = requests.put(url, params=data, headers=headers, json=json, cookies=cookies)
    ...
    @logs
    def delete_request(self, url, data=None, params=None, headers=None, json=None, cookies=None):
        """
        Delete请求
        :param url:
        :param data:
        ...
        try:
            if data is None:
                response = requests.delete(url, params=params, headers=headers, json=json, cookies=cookies)
            else:
                response = requests.put(url, data=data, params=params, headers=headers, json=json, cookies=cookies)
